class FavoritesController < ApplicationController
  def create
    ...
    if @favorite.save
      if request.referer == "http://localhost:3000/companies/#{@company.id}" || request.referer == "https://actionee.herokuapp.com/companies/#{@company.id}" || request.referer == "http://www.actionee.net/companies/#{@company.id}"
